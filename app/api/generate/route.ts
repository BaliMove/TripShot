...
CRITICAL NEGATIVE: (room, interior, wall, wallpaper pattern, furniture, painting on wall, picture frame, shelf, curtain, window, clutter in background:1.8), (deformed ears, mutated ears, unnatural ears, weird ears, fake ears sticking out of hair:1.5), (slicked back hair, unnaturally flattened hair, bald appearance, tight hair bun:1.3), cropped head, cropped hair, cropped ears, cropped chin, head touching top border, tight face crop, oversized giant face, plastic skin, 3d render, cartoon, blurry, lowres.`;
          ...
          prompt += ` CRITICAL 100% REAL-FACE & EYE FIDELITY (id_weight: 1.0): Reconstruct the subject's authentic 1:1 real face from Image 1: natural wide-open large eyes, clear distinct double eyelids, authentic nose bridge width and tip, natural smile, and authentic cheekbones/jawline. CRITICAL: The eyes MUST remain naturally wide open with visible dark pupils and clear double eyelids matching Image 1. Strictly DO NOT squint eyes, DO NOT narrow eyes into slits, DO NOT squint against the sun, and DO NOT alter the face into a generic stranger. Environmental Knee-Up or Thigh-Up Shot occupying 33%-40% of vertical frame height (ensuring high-resolution facial clarity), allowing the landmark panorama to occupy 60%-67% of the frame. Completely replace casual indoor home clothes with stylish vacation travel attire.`;
        }
      }
...
2. STRICT 100% REAL FACE LOCK & EYE INTEGRITY: Preserve 100% exact authentic facial identity, wide-open eyes, double eyelids, nose, lips, jawline, and natural smile of EVERY real person from Image 1 with id_weight: 1.0. Do NOT squint eyes, do NOT alter eye shape into small slits.
3. THEME & PROPORTIONS: Harmoniously maintain the original scene theme for "${styleId}". Keep realistic environmental proportions (subject occupies 33%-40% of frame height for high-resolution facial clarity, landmark occupies 60%-67%). DO NOT zoom in to oversized headshot.
