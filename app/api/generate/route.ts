...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    if (customBgBase64) {
      ...
      prompt = `(masterpiece, best quality:1.2), RAW unretouched photo, 8k uhd, shot on Canon EOS R5 (35mm-50mm environmental prime lens at f/2.8) seamlessly integrating ALL person(s) present in Image 1 (Indoor/Casual Portrait) naturally into the scenic/extreme destination backdrop in Image 2 (Scenic/Extreme Landscape Background).
