...
const firebaseConfig = {
  apiKey: process.env.NEXT_PUBLIC_FIREBASE_API_KEY || "AIzaSyDummyKeyForTripshotWorldAuth2026",
  ...
  storageBucket: process.env.NEXT_PUBLIC_FIREBASE_STORAGE_BUCKET || "tripshot-world.appspot.com",
  messagingSenderId: process.env.NEXT_PUBLIC_FIREBASE_MESSAGING_SENDER_ID || "1082736451",
  appId: process.env.NEXT_PUBLIC_FIREBASE_APP_ID || "1:1082736451:web:abc123tripshot",
};
