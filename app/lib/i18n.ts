...
> = {
  ...
  id_photo: {
    ko: { label: "표준 증명사진", description: "주민증·면허증 규격 (얼굴 55~65% 바스트 샷)" },
    en: { label: "Standard ID Photo", description: "Official National ID & Driver's License standard (Face 55-65% bust crop)" },
    ja: { label: "標準 証明写真", description: "マイナンバー・運転免許証公式規格 (顔55〜65% バストショット)" },
    zh: { label: "标准 证件照", description: "居民身份证与驾照官方规格 (面部占比55~65% 胸像)" },
    id: { label: "Pas Foto Standar KTP", description: "Standar resmi KTP & SIM (Wajah 55-65% pose dada)" },
  },
  passport: {
    ko: { label: "여권·비자 규격 사진", description: "ICAO 국제 공식 여권 규격 (얼굴 70~80% 타이트 헤드샷)" },
    en: { label: "Official Passport Photo", description: "ICAO International compliant standard (Face 70-80% tight headshot)" },
    ja: { label: "公式 パスポート写真", description: "ICAO国際規格準拠 (顔70〜80% タイトヘッドショット)" },
    zh: { label: "护照·签证标准照", description: "符合ICAO国际民航组织官方标准 (面部占比70~80% 头部特写)" },
    id: { label: "Pas Foto Paspor Resmi", description: "Sesuai standar internasional ICAO (Wajah 70-80% pas foto ketat)" },
  },
  student: {
    ko: { label: "학생증·단정 프로필", description: "산뜻한 셔츠 차림 스마트 캐주얼 (얼굴 50~60% 상반신)" },
    en: { label: "Student ID & Clean Profile", description: "Fresh smart casual shirt attire (Face 50-60% upper chest crop)" },
    ja: { label: "学生証・清楚プロフィール", description: "爽やかなシャツ姿のスマートカジュアル (顔50〜60% 上半身)" },
    zh: { label: "学生证·清新头像", description: "干净得体的衬衫便服 (面部占比50~60% 上半身)" },
    id: { label: "Kartu Pelajar & Profil Bersih", description: "Kemeja rapi smart casual (Wajah 50-60% bagian dada ke atas)" },
  },
  astronaut: {
