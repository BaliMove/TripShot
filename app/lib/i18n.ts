...
export const TRANSLATIONS: Record<Language, Translation> = {
  ko: {
    ...
    pricingTitle: "합리적인 요금제 안내",
    pricingSub: "필요한 만큼 충전하고 평생 소장할 수 있는 고화질 화보를 제작해 보세요.",
    planStarterTitle: "Starter 패스",
    planStarterBadge: "⚡ 10회 생성",
    planStarterDesc: "인생샷 10장 생성 권한 (HD 고화질 소장)",
    planStarterF1: "10장 고화질 AI 합성",
    planStarterF2: "기본 화질 다운로드 지원",
    planStarterF3: "모든 글로벌 명소 템플릿 이용",
    planProTitle: "Pro 프로 패스",
    planProBadge: "⭐ MOST POPULAR (30회)",
    planProDesc: "월 30장 생성 & Full HD(2K) 무제한 스튜디오 혜택",
    planProF1: "30장 고화질 AI 합성",
    planProF2: "2K 고해상도 & 즉시 인화 시트",
    planProF3: "비즈니스 & 여권 규격 템플릿 포함",
    planUltimateTitle: "Ultimate VIP 패스",
    planUltimateBadge: "👑 VIP (100회)",
    planUltimateDesc: "월 100장 생성 & 4K Ultra HD + 워터마크 100% 제거",
    planUltimateF1: "100장 초고화질 AI 생성",
    planUltimateF2: "4K Ultra HD 원본 소장",
    planUltimateF3: "최우선 초고속 렌더링 혜택",
  ...
  en: {
    ...
    pricingSub: "Recharge credits as needed and download HD master portraits forever.",
    planStarterTitle: "Starter Pass",
    planStarterBadge: "⚡ 10 Generations",
    planStarterDesc: "10 HD photo generations for quick trial",
    planStarterF1: "10 High-Quality AI Composites",
    planStarterF2: "Standard HD Download",
    planStarterF3: "Access to all global landmark templates",
    planProTitle: "Pro Pass",
    planProBadge: "⭐ MOST POPULAR (30 Credits)",
    planProDesc: "30 Generations & Full 2K Studio Features",
    planProF1: "30 Ultra High-Quality AI Composites",
    planProF2: "2K High-Res & Printable Photo Sheet",
    planProF3: "Includes Business Suit & Passport formats",
    planUltimateTitle: "Ultimate VIP Pass",
    planUltimateBadge: "👑 VIP (100 Credits)",
    planUltimateDesc: "100 Generations & 4K Ultra HD + No Watermark",
    planUltimateF1: "100 Masterpiece 4K AI Generations",
    planUltimateF2: "Original 4K Ultra HD Downloads",
    planUltimateF3: "Priority High-Speed GPU Queue",
  ...
  ja: {
    ...
    pricingBadge: "PRICING PLANS",
    pricingTitle: "お手頃な料金プラン",
    pricingSub: "必要な分だけチャージして、高画質な写真を永久保存できます。",
    planStarterTitle: "Starter パス",
    planStarterBadge: "⚡ 10回生成",
    planStarterDesc: "お試し用10回生成（HD高画質）",
    planStarterF1: "10回 AI写真生成",
    planStarterF2: "標準HDダウンロード",
    planStarterF3: "すべての名所テンプレート利用可能",
    planProTitle: "Pro パス",
    planProBadge: "⭐ 一番人気 (30回)",
    planProDesc: "月30回生成＆2K高画質スタジオ機能",
    planProF1: "30回 高画質AI写真生成",
    planProF2: "2K超高画質＆印刷用シート生成",
    planProF3: "ビジネススーツ・証明写真対応",
    planUltimateTitle: "Ultimate VIP パス",
    planUltimateBadge: "👑 VIP (100回)",
    planUltimateDesc: "月100回生成＆4K超高画質＋透かし完全除去",
    planUltimateF1: "100回 最高峰4K AI写真生成",
    planUltimateF2: "4K Ultra HD 原寸ダウンロード",
    planUltimateF3: "最優先 高速レンダリング",
  ...
  zh: {
    ...
    pricingBadge: "PRICING PLANS",
    pricingTitle: "高性价比价格方案",
    pricingSub: "按需充值点数，永久珍藏超清AI摄影大片。",
    planStarterTitle: "Starter 入门卡",
    planStarterBadge: "⚡ 10次生成",
    planStarterDesc: "10次高清照片生成体验",
    planStarterF1: "10张 高清AI大片合成",
    planStarterF2: "标准高清下载支持",
    planStarterF3: "所有全球名胜模板均可使用",
    planProTitle: "Pro 专业卡",
    planProBadge: "⭐ 最受欢迎 (30次)",
    planProDesc: "30次生成 & 2K超清摄影与影棚功能",
    planProF1: "30张 超高清AI写真",
    planProF2: "2K超清分辨率 & 冲印排版排照",
    planProF3: "包含商务职业装与证件照模板",
    planUltimateTitle: "Ultimate VIP卡",
    planUltimateBadge: "👑 VIP (100次)",
    planUltimateDesc: "100次生成 & 4K原生超清 + 无水印",
    planUltimateF1: "100张 4K顶级画质AI摄影",
    planUltimateF2: "4K Ultra HD 原图珍藏",
    planUltimateF3: "顶级GPU优先超速渲染",
    btnSelectPlan: "选择此方案",
  ...
  id: {
    ...
    pricingBadge: "PRICING PLANS",
    pricingTitle: "Pilihan Paket Terjangkau",
    pricingSub: "Isi ulang kredit sesuai kebutuhan dan unduh foto HD selamanya.",
    planStarterTitle: "Starter Pass",
    planStarterBadge: "⚡ 10x Generate",
    planStarterDesc: "10x pembuatan foto HD untuk mencoba",
    planStarterF1: "10x Komposit Foto AI HD",
    planStarterF2: "Unduh Kualitas Standar HD",
    planStarterF3: "Akses ke semua template wisata global",
    planProTitle: "Pro Pass",
    planProBadge: "⭐ PALING POPULER (30x)",
    planProDesc: "30x Generate & Fitur Studio 2K Lengkap",
    planProF1: "30x Komposit Foto AI Kualitas Tinggi",
    planProF2: "Resolusi 2K & Lembar Cetak Foto Siap Pakai",
    planProF3: "Termasuk format Pasfoto & Jas Bisnis",
    planUltimateTitle: "Ultimate VIP Pass",
    planUltimateBadge: "👑 VIP (100x)",
    planUltimateDesc: "100x Generate & 4K Ultra HD + Tanpa Watermark",
    planUltimateF1: "100x Pembuatan Foto AI 4K Masterpiece",
    planUltimateF2: "Unduh Resolusi Asli 4K Ultra HD",
    planUltimateF3: "Antrean GPU Kecepatan Tinggi Prioritas",
