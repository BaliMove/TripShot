...
- Image 1: PRIMARY & EXCLUSIVE FACE IDENTITY SOURCE. The person in Image 1 is the SOLE INDIVIDUAL to appear in the generated photo. Preserve 100% exact facial bone structure, mature facial features, eye shape, prominent eyebrows, nose bridge, lips, jawline, wrinkles, authentic mature age (do not de-age into a 20-year-old boy), skin tone, and masculinity of the man in Image 1. Strictly DO NOT hallucinate a generic young stranger face.
- Image 2: LOCATION & BACKGROUND VENUE ONLY. Image 2 provides strictly the venue/court environment (e.g. padel tennis court, stadium lights, glass walls). PURGE & OVERWRITE ANY PRE-EXISTING PLAYERS, ATHLETES, OR BYSTANDERS originally in Image 2. Under NO circumstances should you adopt the age, face, or features of anyone originally in Image 2!

[SCENE COMPOSITION & GOLDEN-RATIO FRAMING]:
(masterpiece, best quality:1.2), RAW unretouched photo, 8k uhd, shot on Canon EOS R5 (35mm-50mm environmental lens at f/2.8).
Position the person from Image 1 prominently in the FOREGROUND / MIDGROUND as the HERO ATHLETE holding a padel tennis racket, ready to play.
GOLDEN-RATIO FRAMING: Medium-to-Full or Waist-to-Knee shot occupying 40% to 50% of the vertical frame. The face must be crisp, large, and in sharp focus so the authentic facial identity from Image 1 is 100% recognizable, while the padel court architecture, glass walls, and stadium lighting naturally expand around them (50%-60% background). DO NOT place the subject as a tiny blurry figure in the far distance, and DO NOT zoom into an oversized ID headshot.
Harmonize the lighting on the subject's face and body with the indoor stadium/court lighting of Image 2. Directional rim light, natural floor contact shadows, authentic sub-surface scattering (SSS), and visible microscopic skin pores on Kodak Portra 400 film aesthetic.
Dress the subject in stylish athletic sports attire (athletic polo/t-shirt, shorts/track pants, sneakers) matching the padel court, while keeping 100% original head and face.${customPromptAddon}${fixAddon} Do not render any visible text, watermark, logos, or letters.
CRITICAL NEGATIVE: (plastic skin, waxy skin, airbrushed, smooth skin, poreless skin:1.4), (matte skin, powdery skin, flawless skin:1.3), generic young face, de-aged face, baby face, Asian youth model, wrong face, face drift, stranger face, replaced face, tiny distant figure, blurry face, unrecognizable face, tight close-up, cropped landmark, oversized head, gigantic face filling the entire screen, beauty filter, glam, cgi, 3d render, cartoon, painting, illustration, drawing, unreal engine, ring-light flat lighting, front flash, overexposed highlights, dead eyes, bad anatomy, deformed hands, lowres, watermark, halo artifact around head, hard cutout edges, mismatched lighting, unnatural seams, skin tone boundary mismatch, blurry borders, oversmoothed skin, deformed facial features, mutated eyes, plastic face, asymmetrical jaw, identity drift, duplicated face, identical features across multiple people, swapped identities, merged facial attributes, missing people, dropped members, fake floating cutout.`;
    } else {
      let basePrompt = "";
...
4. MULTI-PERSON REGIONAL SPLIT [SEP]: If multiple individuals (e.g. 2, 4, or a group) are present in Image 1, detect and include ALL of them together [Person 1] [SEP] [Person 2] naturally with balanced group framing.`;
      ...
      finalPrompt = `(masterpiece, best quality:1.2), RAW unretouched photo, 8k uhd, shot on Canon EOS R5 (35mm-50mm environmental prime lens at f/2.8) travel photography masterpiece seamlessly integrating ALL person(s) present in Image 1 into the scene: ${basePrompt}.
CRITICAL MANDATORY INSTRUCTIONS:
